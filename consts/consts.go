...
const (
	...
	SLOWQUERY_THRESHOLD_OUTLINE   = 30.0
	SLOWQUERY_THRESHOLD_VIEWPOINT = 15.0
	SLOWQUERY_THRESHOLD_ANALYSIS  = 180.0
	SLOWQUERY_THRESHOLD_MERGE     = 180.0
	SLOWQUERY_THRESHOLD_MULTIDOC  = 180.0
