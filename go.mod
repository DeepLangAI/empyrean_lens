...
require (
	codeup.aliyun.com/deeplang/lingowhale/lingowhale_backend/go_lib v1.3.10
...
require (
	...
	github.com/sensorsdata/sa-sdk-go v2.1.3+incompatible // indirect
